<%@ Page Title="اتمام الدفع" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HotelReservationPayment.aspx.cs" Inherits="TMSWeb.HotelReservationPayment" %>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="img-fluid text-center">
                            <img src="img/hotelpay.png" class="p-2" height="200px" />
                        </div>
                    </div>
                    <div class="col-6">
